package com.sdu.flink.network.partition;

import static com.sdu.flink.network.NettyUtils.buildNettyConfig;
import static com.sdu.flink.network.NettyUtils.getLocalInetAddress;
import static org.apache.flink.runtime.io.network.partition.ResultPartitionType.PIPELINED;

import com.sdu.flink.entry.UserActionEntry;
import com.sdu.flink.network.Constants;
import com.sdu.flink.network.TaskEventPublisherImpl;
import com.sdu.flink.network.UserActionEmitter;
...
public class UpstreamTMBootstrap {
  ...
  public static void main(String[] args) throws Exception {
    ...
    BufferPoolFactory bufferPoolFactory = new BufferPoolFactory(numRequiredBuffers, PIPELINED, networkBufferPool);
    ResultPartition resultPartition = new ResultPartition("Task0(1/2)", Constants.RP,
